        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <ol>
                    ...
                    <li>Barcode: The barcode of the product.</li>
                    <li>Price: The price of the product.</li>
                    <li>Quantity: The quantity of the product.</li>
                    <li>Status: The status of the product (1 for active, 0 for inactive).</li>
                </ol>
                
            </div>
            <div class="modal-footer">
                <a href="{{ asset('downloads/products.csv') }}" class="btn btn-primary"
