...
class CartController extends Controller
{
    ...
    public function changeQty(Request $request)
    {
        $request->validate([
            ...
            'days' => 'required|integer|min:1', // Add validation for the 'days' field
        ]);
        ...
        if ($cart) {
            ...
            $cart->pivot->days = $request->days; // Update the 'days' value in the pivot table
            $cart->pivot->save();
        }
